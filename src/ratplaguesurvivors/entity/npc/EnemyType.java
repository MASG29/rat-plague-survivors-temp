...
public enum EnemyType {
    MOUSE("Mouse", 10, 20, 5, 1, MouseSpriteType.DOWN_0.getPath()),
    RAT("Rat", 20, 60, 10, 2, RatSpriteType.DOWN_0.getPath()),
    GIGARAT("GigaRat", 50, 20000, 30, 1, BossSpriteType.RUN_DOWN_0.getPath());
    ...
    EnemyType(String name, int health, int xpvalue, int damage, int speed, String spritePath) {
        this.name = name;
        this.health = health;
